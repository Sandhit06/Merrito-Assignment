...
function printConsoleReport(output) {
    ...
    console.log(`Events read: ${summary.total_events_read} | Valid: ${summary.valid_events_processed} | Skipped (malformed): ${summary.events_skipped}`);
    console.log(`Weekly budget: Rs. ${summary.weekly_reorder_budget.toLocaleString()} | Allocated: Rs. ${summary.total_allocated_cost.toLocaleString()} | Remaining: Rs. ${summary.remaining_budget.toLocaleString()}`);
